...
<?php } ?>
                                                ...
                                                <div class="col-md-2 routineFildMarginBottom">
                                                    <input type="text" class="form-control" placeholder="<?php //echo lang('clas_roon_no_plas'); ?> Room No" name="roomNumber" data-validation="required" data-validation-error-msg="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
