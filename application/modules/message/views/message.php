                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <select multiple="yes" id="ajaxStuAndPar" name="receiver_2[]" class="form-control select2me" data-placeholder="<?php echo lang('select'); ?>">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group last">
                                ...
                                <div class="col-md-6">
                                    <textarea class="ckeditor1 form-control" name="message" rows="6" required></textarea>
                                </div>
                            </div>
