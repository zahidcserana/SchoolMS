    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <?php echo 'Add Category'; ?> <small></small>
                </h3>
            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open_multipart('account/add_category', $form_attributs);
                        ?>
                        <div class="form-body">
                            <?php
                            if (!empty($success)) {
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="" name="category_name" data-validation="required" data-validation-error-msg="<?php echo lang('Category name is required field.'); ?>">
                                </div>
                            </div>
