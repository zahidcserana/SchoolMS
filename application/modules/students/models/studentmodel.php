...
class Studentmodel extends CI_Model {
    ...
    public function ownStudentDetails($a) {
        ...
        //This function return a student's details by student database row id.
    public function getStudentDetails($a) {
    ...
    //This function return a user's details .
    public function userGroupDetails($a) {
        $query = $this->db->get_where('users_groups', array('user_id' => $a));
        $data = array();
        foreach ($query->result_array() as $row) {
            $data[] = $row;
        }
    ...
    //This function return a user's details .
    public function parentDetails($a) {
        $query = $this->db->get_where('parents_info', array('user_id' => $a));
        $data = array();
        foreach ($query->result_array() as $row) {
            $data[] = $row;
        }
