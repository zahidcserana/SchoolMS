...
//                        $class_id = $row1['class_id'];
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open_multipart("students/editStudent?di=$studentClass&sid=$studentInfoId&userId=$userId&class_id=$class_id", $form_attributs);
                        ?>
                        <div class="form-body">
                            <?php
                            if (!empty($success)) {
...
<?php foreach ($classStudents as $row3) { ?>
    ...
    <?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control"  value="<?php echo $row3['roll_number']; ?>" name="roll_number" >
                                    </div>
                                </div>

                                 <div class="form-group last">
                                    <label class="control-label col-md-3"> <?php echo lang('admi_students_photo'); ?> <span class=""> </span></label>
                                    <div class="col-md-3">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail">
                                                <img src="assets/uploads/<?php echo $profile_image; ?>" alt="">
                                            </div>
                                            ...
                                            <div>
                                                <span class="btn default btn-file">
                                                    ...
                                                    <input type="file" name="userfile" data-validation="">
                                                </span>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">Student's Attendance Machine ID <span class="requiredStar"> * </span></label>
                                <div class="col-md-6">
                                    <input type="text" name="admi_stu_machine_id" value="<?php echo $row3['stu_machine_id']; ?>" class="form-control" placeholder="Example-1,2,3........" data-validation="required" data-validation-error-msg="Student's Attendance Machine ID is Required">
                                </div>
                            </div>
<?php } ?>
