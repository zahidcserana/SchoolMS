            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        <?php
                        $form_attributs = array('class' => 'form-horizontal', 'role' => 'form', 'name' => 'myForm', 'onsubmit' => 'return validateForm()');
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control date-picker" name="birthdate" id="mask_date2" type="text" data-validation="required" data-validation-error-msg="<?php echo lang('admi_DateOfBirth_error_msg'); ?>">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Mobile Number <span class="requiredStar"> * </span></label>

                                <div class="col-md-1">
                                    <input type="text" readonly="true" class="form-control" name="phoneCode" placeholder="88"  data-validation="required" data-validation-error-msg="" value="88">
                                </div>
                                <div class="col-md-4">
                                    <input type="text" onkeypress='validate_mobile(event)' class="form-control" name="phone" placeholder=""  data-validation="required" data-validation-error-msg="">
                                    <span class="help-block">
                                        01728963258</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="password" class="form-control" name="password" id="password" placeholder="" data-validation="required" data-validation-error-msg="<?php echo lang('Password field is required field.'); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label"><?php echo lang('admi_ConfirmPassword'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-6">
                                    <input type="password" class="form-control" name="password_confirm" id="password_confirm" placeholder="" data-validation="required" data-validation-error-msg="<?php echo lang('admi_ConfirmPassword_error_msg'); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select name="class" id="class" onchange="classInfo(this.value)" class="form-control" data-validation="required" data-validation-error-msg="<?php echo lang('admi_Class_error_msg'); ?>">
...
<?php } ?>
							...
							<div class="col-md-3 col-md-offset-3" id="divCheck">
...
<?php echo lang('admi_stu_photo_remove'); ?> </a>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">Student's Attendance Machine ID</label>
                                <div class="col-md-6">
                                    <input type="text" name="admi_stu_machine_id" class="form-control" placeholder="Example-1,2,3........">
                                </div>
                            </div>
...
<?php echo lang('admi_submit_doc'); ?>
                        ...
                        <div class="form-actions fluid">
                            <div class="col-md-offset-3 col-md-6">
                                <button type="submit" class="btn green" name="submit" id="submit" value="submit"><?php echo lang('save'); ?></button>
...
//here is auto reload after 1 second for time and date in the top
	...
	function check_roll(value)
	{
		var class_id = $("#class").val();
		var sec_id = $("#section").val();
		
		var dataString = {class_id: class_id, sec_id: sec_id, roll: value};
  		//alert(dataString);
		$.ajax({
  		
  		type: "POST",
  		url: "<?= base_url();?>index.php/users/check_roll",
  		data:  dataString,
  		success: function (data)
  		{
  			...
  			if(data == 'FALSE')
  			{
				$("#divCheck").html("Duplicate Roll Use Another");
		        $("#submit").prop('disabled', true);
		        $('#divCheck').css('color', 'red');
			}
			else
		    {
		        $("#divCheck").html("Roll Available Can Use");
		        $("#submit").prop('disabled', false);
		        $('#divCheck').css('color', 'green');
