...
<html lang="en" >
    ...
    <head>
        ...
        <meta content="" name="Md. Saifur Rahman"/>
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content page-header-fixed-mobile page-footer-fixed1">
        ...
        if ($cont == "home") {
            ...
            if ($view == "add_account_category") {
                $account = $s . ' ' . $a;
                $setAaccount_category = $s . ' ' . $a;
                $add_account_category = $a;
            }elseif ($view == "category_list") {
                $account = $s . ' ' . $a;
                $setAaccount_category = $s . ' ' . $a;
                $category_list = $a;
            }elseif ($view == "editCategory") {
                ...
                $setAaccount_category = $s . ' ' . $a;
                $editCategory = $a;
            }elseif ($view == "add_account_head") {
                $account = $s . ' ' . $a;
                $accountHead = $s . ' ' . $a;
                $add_account_head = $a;
            }elseif ($view == "account_head_list") {
                $account = $s . ' ' . $a;
                $accountHead = $s . ' ' . $a;
                $account_head_list = $a;
            }elseif ($view == "edit_account_head") {
                $account = $s . ' ' . $a;
                $accountHead = $s . ' ' . $a;
                $edit_account_head = $a;
            }elseif ($view == "addAccountSubHead") {
                $account = $s . ' ' . $a;
                $accountSubHead = $s . ' ' . $a;
                $addAccountSubHead = $a;
            }elseif ($view == "account_sub_head_list") {
                $account = $s . ' ' . $a;
                $accountSubHead = $s . ' ' . $a;
                $account_sub_head_list = $a;
            }elseif ($view == "edit_account_sub_head") {
                $account = $s . ' ' . $a;
                $accountSubHead = $s . ' ' . $a;
                $edit_account_sub_head = $a;
            }elseif ($view == "addTransaction") {
                $account = $s . ' ' . $a;
                $add_Transaction = $s . ' ' . $a;
                $addTransaction = $a;
            }elseif ($view == "transactionList") {
                $account = $s . ' ' . $a;
                $add_Transaction = $s . ' ' . $a;
                $transactionList = $a;
            }elseif ($view == "money_receipt") {
                $account = $s . ' ' . $a;
                $add_Transaction = $s . ' ' . $a;
                $transactionList = $a;
            }elseif ($view == "ViewPayment") {
                $account = $s . ' ' . $a;
                $add_Transaction = $s . ' ' . $a;
                $transactionList = $a;
            }elseif ($view == "transection") {
...
<!--                                    <li class="nav-item <?php echo $addAccount; ?>">
                                        ...
                                        <li class="nav-item <?php echo $setAaccount_category; ?>">
                                            <a href="javascript:;" class="nav-link nav-toggle">
                                            ...
                                            <ul class="sub-menu">
                                                <?php if ($this->common->user_access('add_account_title', $userId)) { ?>
                                                    <li class="nav-item <?php echo $add_account_category; ?>">
                                                        <a href="index.php/account/add_account_category" class="nav-link ">
                                                            <span class="title">Add Account Type</span>
                                                        </a>
                                                    </li>
                                                <?php } if ($this->common->user_access('add_account_title', $userId)) { ?>
                                                    <li class="nav-item <?php echo $category_list; ?>">
                                                        <a href="index.php/account/category_list" class="nav-link">
                                                            <span class="title">Account Type List</span>
                                                        </a>
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                        ...
                                        <li class="nav-item <?php echo $accountHead; ?>">
                                            <a href="javascript:;" class="nav-link nav-toggle">
                                            ...
                                            <ul class="sub-menu">
                                                <?php if ($this->common->user_access('add_account_title', $userId)) { ?>
                                                    <li class="nav-item <?php echo $add_account_head; ?>">
                                                        <a href="index.php/account/add_account_head" class="nav-link ">
                                                            <span class="title">Add Account Head</span>
                                                        </a>
                                                    </li>
                                                <?php } if ($this->common->user_access('add_account_title', $userId)) { ?>
                                                    <li class="nav-item <?php echo $account_head_list; ?>">
                                                        <a href="index.php/account/account_head_list" class="nav-link">
                                                            <span class="title">Account Head List</span>
                                                        </a>
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                        ...
                                        <li class="nav-item <?php echo $accountSubHead; ?>">
                                            <a href="javascript:;" class="nav-link nav-toggle">
                                                <span class="title">Account Sub Head</span>
                                                <span class="arrow"></span>
                                            </a>
                                            <ul class="sub-menu">
                                                <?php if ($this->common->user_access('add_account_title', $userId)) { ?>
                                                    <li class="nav-item <?php echo $addAccountSubHead; ?>">
                                                        <a href="index.php/account/addAccountSubHead" class="nav-link ">
                                                            <span class="title">Add Account Sub Head</span>
                                                        </a>
                                                    </li>
                                                <?php } if ($this->common->user_access('add_account_title', $userId)) { ?>
                                                    <li class="nav-item <?php echo $account_sub_head_list; ?>">
                                                        <a href="index.php/account/account_sub_head_list" class="nav-link">
                                                            <span class="title">Account Sub Head List</span>
                                                        </a>
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                        ...
                                        <li class="nav-item <?php echo $add_Transaction; ?>">
                                            <a href="javascript:;" class="nav-link nav-toggle">
                                            ...
                                            <ul class="sub-menu">
                                                <?php if ($this->common->user_access('add_account_title', $userId)) { ?>
                                                    <li class="nav-item <?php echo $addTransaction; ?>">
                                                         <a href="index.php/account/addTransaction" class="nav-link ">
                                                            <span class="title">Add Transaction</span>
                                                        </a>
                                                    </li>
                                                <?php }  ?>
                                                <?php if ($this->common->user_access('add_account_title', $userId)) { ?>
                                                    <li class="nav-item <?php echo $transactionList; ?>">
                                                         <a href="index.php/account/transactionList" class="nav-link ">
                                    ...
                                    <li class="nav-item <?php echo $allSlips; ?>">
                                        ...
                                        <?php } if ($this->common->user_access('trensection', $userId)) { ?>
                                             <li class="nav-item <?php echo $addTransaction; ?>">
                                                 <a href="index.php/account/money_receipt" class="nav-link ">
                                        ...
                                        <?php } if ($this->common->user_access('pay_salary', $userId)) { ?>
                                            <li class="nav-item <?php echo $addTransaction; ?>">
                                                 <a href="index.php/account/ViewPayment" class="nav-link ">
                        ...
                        <?php } if ($this->common->user_access('add_category', $userId) || $this->common->user_access('all_category', $userId) || $this->common->user_access('add_books', $userId) || $this->common->user_access('all_books', $userId) || $this->common->user_access('add_library_mem', $userId) || $this->common->user_access('memb_list', $userId)) { ?>
