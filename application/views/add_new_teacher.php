                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"><?php echo lang('tea_fna'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control date-picker" name="birthdate" id="mask_date2" type="text"  data-validation="required" data-validation-error-msg="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-1">
                                    <input type="text" readonly="true" class="form-control" value="88" name="phoneCode" placeholder="88"  data-validation="required" data-validation-error-msg="" >
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <span class="help-block">01728963258</span>
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <div>
                                            <span class="btn default btn-file">
                                                <span class="fileinput-new"><?php //echo lang('tea_si'); ?> Browse Image </span>
