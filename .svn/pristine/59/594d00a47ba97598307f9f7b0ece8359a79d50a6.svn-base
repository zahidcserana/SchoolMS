                            ...
                            <tbody>
                                <?php foreach ($parents as $row) { ?>
                                    <tr>
                                        ...
                                        <?php if ($this->common->user_access('parents_edit_dlete', $userId)) { ?>
                                        <td>
                                                <a class="btn btn-xs default" href="index.php/parents/editParentsInfo?painid=<?php echo $row['id']; ?>&puid=<?php echo $puserid; ?>"> <i class="fa fa-pencil-square"></i> <?php echo lang('edit'); ?> </a>
                                                ...
                                                <a class="btn btn-xs red" href="index.php/parents/deleteParents/<?php echo $row['id']; ?>" onClick="javascript:return confirm('<?php echo lang('par_aysywtdtgp'); ?>')"> <i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?> </a>
                                        </td>
                                        <?php } ?>
                                    </tr>
                                <?php } ?>
