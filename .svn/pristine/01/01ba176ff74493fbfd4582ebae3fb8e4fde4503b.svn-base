    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    <?php echo 'Add Account Sub Head'; ?> <small></small>
                </h3>
            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open_multipart('account/addAccountSubHead', $form_attributs);
                        ?>
                        <div class="form-body">
                            <?php
                            if (!empty($success)) {
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select name="accounts_head_id" data-validation="required" class="form-control">
                                        ...
                                        <option value="<?php echo $value['id']; ?>"><?php echo $value['accounts_head_name'] ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" placeholder="Account Sub Head Name" name="sub_head_name" data-validation="required" data-validation-error-msg="<?php echo lang('Account sub head name is required field.'); ?>">
                                </div>
                            </div>
                            <div class="form-group">
