                        ...
                        ?>
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input name="capicity" class="form-control" placeholder="Students Capacity in a section"  data-validation="required" data-validation-error-msg="Give section's student capacity." />
<!--                                        <select name="capicity" class="form-control"  data-validation="required" data-validation-error-msg="Select section's student capacity.">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="class_code" onkeyup="classSection(this.value)" class="form-control" placeholder="Class Code"  data-validation="required" data-validation-error-msg="<?php echo lang('clas_code_requir'); ?>">
                                    </div>
<!--                                    <div class="col-md-6">
...
<script>
    $(function() {
        ...
        $('#addGroup').live('click', function() {
            if (x < maxFild) {
                x++;
                $('<div id="remove" class="addGroupMarginBottom"><input type="text" name="group_' + i + '" class="form-control" placeholder="Group title here"> <a href="#" id="remGroup" class="btn btn-danger">Remove</a></div>').appendTo(scntDiv);
                i++;
                return false;
            }
        });
    ...
    $(function() {
        ...
        $('#addSection').live('click', function() {
            if (x < maxFild) {
                x++;
                $('<div id="remove2" class="addGroupMarginBottom"><input type="text" name="section_' + i + '" class="form-control" placeholder="Section title here"> <a href="#" id="remSection" class="btn btn-danger">Remove</a></div>').appendTo(scntDiv);
                i++;
                return false;
            }
        });
