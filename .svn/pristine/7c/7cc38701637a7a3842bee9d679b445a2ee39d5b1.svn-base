                ...
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            ...
                            foreach ($info as $row) {
                                $schoolName = $row['school_name']; $startingYear = $row['starting_year']; $headMaster = $row['headmaster_name']; $address = $row['address']; $phone = $row['phone']; $email = $row['email']; $value2 = $row['currenct']; $currenct = $row['currenct']; $country = $row['country']; $value = $row['time_zone']; $countryPhonCode = $row['countryPhonCode'];
                                } ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="phoneNumberCode" placeholder="" value="<?php echo $countryPhonCode; ?>" required>
                                    <span class="help-block">+88</span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select name="currency" class="form-control currencyConfig" required>
                                        ...
                                        <option value="fa fa-money"> &#xf0d6; &nbsp; Taka (BDT) </option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select name="timeZone" class="form-control" required>
                                        ...
                                        <option value="UP5"> (UTC + 6:00) Almaty, Colomba, Dhaka</option>
