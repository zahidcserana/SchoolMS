                                ...
                                foreach ($issu_item as $row2) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-xs red" href="index.php/stock/delete_issue?id=<?php echo $row2['id']; ?>" onClick="javascript:return confirm('Are you sure you want to delete this Issue item?')"> <i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?> </a>
                                        </td>
                                    </tr>
                                    <?php
                                    $i++;
