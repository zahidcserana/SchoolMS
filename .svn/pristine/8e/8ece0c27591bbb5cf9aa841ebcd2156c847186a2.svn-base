                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-2 classGroupInput">
                                                    <input type="text" class="form-control date-picker" id="mask_date2" placeholder="<?php echo lang('exa_ddmmyy'); ?>" value="<?php echo $startDate; ?>" name="examDate" readonly="" data-validation="required" data-validation-error-msg="">
                                                </div>
                                                <div class="col-md-2 classGroupInput">
                                                ...
                                                <div class="col-md-2 classGroupInput">
                                                    <input type="text" class="form-control" placeholder="Room No" name="romeNo" data-validation="required" data-validation-error-msg="">
                                                </div>
                                                <div class="col-md-2 classGroupInput">
