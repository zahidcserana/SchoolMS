                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" class="form-control" value="<?php echo $paymentData->paid; ?>" id="paid" name="paid" readonly="">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">Balance <span class="requiredStar">  </span></label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" value="<?php echo $paymentData->balance; ?>" id="balance" name="balance" readonly="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">Total Due <span class="requiredStar">  </span></label>
                                <div class="col-md-5">
                                    <input type="text" class="form-control" id="total_due" value="<?php if($paymentData->balance == 0){ echo ($paymentData->total - $paymentData->paid - $paymentData->balance + $paymentData->fine); } else { echo "0"; } ?>"  name="total_due" readonly="">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label"> Payment Type <?php //echo lang('admi_blood'); ?> <span class="requiredStar"> * </span></label>
                                <div class="col-md-5">
                                    <select required="true" name="method" class="form-control" data-validation-error-msg="Pleas select payment method.">
