                    ...
                    <ul class="ver-inline-menu tabbable margin-bottom-10">
                        ...
                        <?php if($this->common->user_access('stud_edit_delete',$userId)){ ?>
                            <li>
                                ...
                                $studentClassId = $this->input->get('id');
                                $studentInfoId = $this->input->get('sid');
                                $stuUserId = $this->input->get('userId');
                                $class = $this->input->get('class_id');
                                ?>
                                <a href="index.php/students/editStudent?di=<?php echo $studentClassId; ?>&sid=<?php echo $studentInfoId; ?>&userId=<?php echo $stuUserId; ?>&class_id=<?php echo $class; ?>">
                    ...
                    <div class="portlet sale-summary">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7 col-xs-6 detailsEvent">
                                <?php echo $studentPercentise; //$data2['starting_year']; ?>
                            </div>
                        </div>
                    </div>
                </div>
