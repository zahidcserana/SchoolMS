...
//                                    $class = $row['class_title'];
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-xs green tableActionButtonMargin" href="index.php/students/students_details?id=<?php echo $row['id']; ?>&sid=<?php echo $studentId; ?>&userId=<?php echo $stuUserId; ?>&class_id=<?php echo $class_id; ?>"> <i class="fa fa-file-text-o"></i> <?php echo lang('stu_clas_Details'); ?> </a>
